...
#define penguin_motor_getDetectedCurrent(x)    (penguin_motor_sendrecvData_hexint((x), "MON;0F"))
#define penguin_motor_getEffectiveLoadFactor(x)(penguin_motor_sendrecvData_hexint((x), "MON;0D"))
#define penguin_motor_getLoadFactor(x)         (penguin_motor_sendrecvData_int((x), "LMON"))
