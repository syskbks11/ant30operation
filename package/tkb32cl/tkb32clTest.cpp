...
int _killCIWProcess(){
	...
	pid = 0;
        ...
        if((fp = popen("pgrep -f -x '/usr/bin/java -jar /home/user/enohi/java/test/inubuyo-ciw-0.0.jar'", "r")) != NULL){
...
*/
       ...
       FILE* ciw = popen("/usr/bin/java -jar /home/user/enohi/java/test/inubuyo-ciw-0.0.jar", "r");
       p.ttw = popen("/usr/bin/java -jar /home/user/enohi/java/test/inubuyo-ttw-0.1.jar", "w");
