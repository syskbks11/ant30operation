#ifndef INCLUDE_GUARD_UUID_54087d9f_9fe3_40ad_b418_5b749f8c5633
#define INCLUDE_GUARD_UUID_54087d9f_9fe3_40ad_b418_5b749f8c5633
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
#include <fcntl.h>
...
int penguin_weather_init(const char* devName){
  /* open device file */
  const int fd = open(devName,O_RDWR | O_NOCTTY);// open as readable/writable w/o tty operation
  if(fd<0){
    perror(devName);
  	exit(1);
  }
...
int penguin_weather_getData(double* res){
  //static double res[3];
