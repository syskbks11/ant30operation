...
extern int trk_20_cmt (double, double *, double *, double *, double *);
extern void trk_21_ (
  double *, double *, double *, double *, double *, double *, double *, double *, double *, double *,
  int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int *,
  double *, double *, double *, double *, double *, double *, double *,
  int *, int *, int *, double *, int *, double *, double *, double *, double *, double *
);
...
#endif
{
  ...
  static double dang;		/* ポジションアングル [rad] */
  ...
  if (t_cmt.imax != -1) {
    if (trk_20_cmt(dtime, &dsrc[0], &dist, &dang, &delt[0]) != 0) {
      return( -2 );
    }
  } else {
    dsrc[0] = 0.0e0;
