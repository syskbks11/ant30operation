#ifndef INCLUDE_GUARD_UUID_e0eb153f_a744_47ec_83dd_45ca4122f960
#define INCLUDE_GUARD_UUID_e0eb153f_a744_47ec_83dd_45ca4122f960
/*!
¥file instrument.cpp
¥author NAGAI Makoto
¥date 2009.2.6
...
//121020 60cm_model (B++)
	...
	*dX = ( p.rP[0]*sin(X+Y) + p.rP[1]*cos(X+Y) + p.rP[2] + p.rP[4]*cos(Y) + p.rP[5]*sin(Y) ) / cos(Y);
