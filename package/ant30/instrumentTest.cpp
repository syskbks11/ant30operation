#ifndef INCLUDE_GUARD_UUID_99e571e9_6428_4650_8882_845ec57f9d60
#define INCLUDE_GUARD_UUID_99e571e9_6428_4650_8882_845ec57f9d60
/*!
...
int manageCommand(char* cmd){
	...
	printf("opt(%lf, %lf) = (%lf, %lf)\n", x, y, dx, dy);
	x += dx;
	y += dy;
	instrumentRadioModel(x, y, &dx, &dy);
	printf("rad(%lf, %lf) = (%lf, %lf)\n", x, y, dx, dy);
	return 1;
}
int main(){
	confInit();
