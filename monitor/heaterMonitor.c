...
#include "../glacier/monitor/glacier_monitor.h"
...
void draw_fixedLabels(){
	...
	setHeader("HEATER MONITOR ver.0.1");
	
	//setColor(2);//green
	setFixedLabel("El Motor", 0, 0);
	//setColor(5);//
	//setBackgroundColor(5);
	setFixedLabel("El Bear.", 1, 0);
	//setColor(6);//
	setFixedLabel("Az Motor", 2, 0);
